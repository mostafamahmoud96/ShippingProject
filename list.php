...
?>
    <div class="card">
        <div class="card-header">
            Track Shipping
            <span style="float: right;">
                <a href="<?php echo '?title=create&sub=track' ?>" class="btn-sm icon icon-left btn-success"><i data-feather="alert-circle" style="float: right;"></i>
                                ...
                                <div class="btn-group  mb-1">
                                    ...
                                    <div class="dropdown-menu dropdown" style="margin: 0px;">
                                        <form class="px-2 py-2" method="post">
                                            ...
                                            <button type="submit" name='submit_status' class="btn btn-secondary">Change Status</button>
                                        </form>
                                        <?php
